...
BOOL CSerial::EscapeCommFunction(unsigned long func) {
	return ::EscapeCommFunction(m_hFile, func);
}

CString CSerial::EPortError(EPort e) {
	CString msg;
	switch (e) {
	case EPortUnknownError:
		msg = "Unknown Error";
		break;
	case EPortAvailable:
		msg = "Port Available";
		break;
	case EPortNotAvailable:
		msg = "Not Available";
		break;
	case EPortInUse:
		msg = "In Use";
