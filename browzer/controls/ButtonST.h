...
public:
	...
	DWORD SetBitmaps(LPCTSTR nBitmapIn, COLORREF crTransColorIn, 
		LPCTSTR nBitmapHover, COLORREF crTransColorHover, 
		LPCTSTR nBitmapOut = NULL, COLORREF crTransColorOut = 0);
