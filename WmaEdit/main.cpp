...
//------------------------------------------------------------------------------
HRESULT ModifyAttrib( WCHAR * pwszInFile, 
                      WORD wStreamNum, 
                      WORD wAttribIndex, 
                      WORD wAttribType, 
...
//------------------------------------------------------------------------------
HRESULT DeleteAttrib( WCHAR * pwszInFile, 
                      WORD wStreamNum, 
                      WORD wAttribIndex )
{
    HRESULT hr = S_OK;
...
//------------------------------------------------------------------------------
HRESULT ShowAttributes3( WCHAR* pwszInFile, WORD wStreamNum )
{
    HRESULT             hr              = S_OK;
...
//       using IWMHeaderInfo.
//------------------------------------------------------------------------------
HRESULT ShowAttributes( WCHAR * pwszInFile, WORD wStreamNum )
{
    HRESULT             hr                  = S_OK;
