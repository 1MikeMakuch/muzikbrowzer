========================================================================
       MICROSOFT FOUNDATION CLASS LIBRARY : id3tagger
========================================================================


AppWizard has created this id3tagger application for you.  This application
not only demonstrates the basics of using the Microsoft Foundation classes
but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your id3tagger application.
...
id3tagger.h
    ...
    CId3taggerApp application class.
...
res\id3tagger.ico
    ...
    icon is included by the main resource file id3tagger.rc.
...
id3taggerDlg.h, id3taggerDlg.cpp - the dialog
    These files contain your CId3taggerDlg class.  This class defines
    the behavior of your application's main dialog.  The dialog's
    template is in id3tagger.rc, which can be edited in Microsoft
	Visual C++.

DlgProxy.h, DlgProxy.cpp - the automation object
    These files contain your CId3taggerDlgAutoProxy class.  This class
...
StdAfx.h, StdAfx.cpp
    ...
    named id3tagger.pch and a precompiled types file named StdAfx.obj.
